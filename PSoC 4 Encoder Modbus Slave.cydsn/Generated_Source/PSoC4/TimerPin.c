...
*
*  TimerPin_DM_STRONG     Strong Drive 
*  TimerPin_DM_OD_HI      Open Drain, Drives High 
*  TimerPin_DM_OD_LO      Open Drain, Drives Low 
*  TimerPin_DM_RES_UP     Resistive Pull Up 
*  TimerPin_DM_RES_DWN    Resistive Pull Down 
*  TimerPin_DM_RES_UPDWN  Resistive Pull Up/Down 
*  TimerPin_DM_DIG_HIZ    High Impedance Digital 
*  TimerPin_DM_ALG_HIZ    High Impedance Analog 
*
* Return: 
*  None
*
