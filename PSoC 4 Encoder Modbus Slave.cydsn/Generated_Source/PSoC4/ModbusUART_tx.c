...
*
*  ModbusUART_tx_DM_STRONG     Strong Drive 
*  ModbusUART_tx_DM_OD_HI      Open Drain, Drives High 
*  ModbusUART_tx_DM_OD_LO      Open Drain, Drives Low 
*  ModbusUART_tx_DM_RES_UP     Resistive Pull Up 
*  ModbusUART_tx_DM_RES_DWN    Resistive Pull Down 
*  ModbusUART_tx_DM_RES_UPDWN  Resistive Pull Up/Down 
*  ModbusUART_tx_DM_DIG_HIZ    High Impedance Digital 
*  ModbusUART_tx_DM_ALG_HIZ    High Impedance Analog 
*
* Return: 
*  None
*
