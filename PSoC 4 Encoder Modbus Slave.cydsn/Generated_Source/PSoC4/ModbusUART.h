...
#define ModbusUART_CY_SCBIP_V0    (CYIPBLOCK_m0s8scb_VERSION == 0u)
#define ModbusUART_CY_SCBIP_V1    (CYIPBLOCK_m0s8scb_VERSION == 1u)
#define ModbusUART_CY_SCBIP_V2    (CYIPBLOCK_m0s8scb_VERSION >= 2u)
...
#else
    #define ModbusUART_SCB_MODE_SPI_INC  (0u)
    #define ModbusUART_SCB_MODE_UART_INC (0u)
...
#define ModbusUART_REMOVE_SCB_CLK     (0u)
#define ModbusUART_SCB_CLK_INTERNAL   (0u == ModbusUART_REMOVE_SCB_CLK)
...
#if (ModbusUART_SCB_CLK_INTERNAL)
    #include "ModbusUART_SCBCLK.h"
#endif /* (ModbusUART_SCB_CLK_INTERNAL) */
...
/* Interface to internal interrupt component */
    ...
    #define ModbusUART_EnableInt()        CyIntEnable      (ModbusUART_ISR_NUMBER)
    #define ModbusUART_DisableInt()       CyIntDisable     (ModbusUART_ISR_NUMBER)
    #define ModbusUART_ClearPendingInt()  CyIntClearPending(ModbusUART_ISR_NUMBER)
#endif /* (ModbusUART_SCB_IRQ_INTERNAL) */

#if (ModbusUART_UART_RX_WAKEUP_IRQ)
    #define ModbusUART_RxWakeEnableInt()        CyIntEnable      (ModbusUART_RX_WAKE_ISR_NUMBER)
    #define ModbusUART_RxWakeDisableInt()       CyIntDisable     (ModbusUART_RX_WAKE_ISR_NUMBER)
    #define ModbusUART_RxWakeClearPendingInt()  CyIntClearPending(ModbusUART_RX_WAKE_ISR_NUMBER)
...
#define ModbusUART_STATUS_PTR             ( (reg32 *) ModbusUART_SCB__STATUS)
    ...
    #define ModbusUART_UART_FLOW_CTRL_REG     (*(reg32 *) ModbusUART_SCB__UART_FLOW_CTRL)
    #define ModbusUART_UART_FLOW_CTRL_PTR     ( (reg32 *) ModbusUART_SCB__UART_FLOW_CTRL)
...
#if (ModbusUART_CY_SCBIP_V0 || ModbusUART_CY_SCBIP_V1)
    #define ModbusUART_FF_DATA_NR_LOG2_PLUS1_MASK (0x0Fu) /* FF_DATA_NR_LOG2_PLUS1 = 4, MASK = 2^4 - 1 = 15 */
    #define ModbusUART_FF_DATA_NR_LOG2_MASK       (0x07u) /* FF_DATA_NR_LOG2 = 3, MASK = 2^3 - 1 = 7 */
#else
    #define ModbusUART_FF_DATA_NR_LOG2_PLUS1_MASK (0x1Fu) /* FF_DATA_NR_LOG2_PLUS1 = 5, MASK = 2^5 - 1 = 31 */
    #define ModbusUART_FF_DATA_NR_LOG2_MASK       (0x0Fu) /* FF_DATA_NR_LOG2 = 4, MASK = 2^4 - 1 = 15 */
#endif /* (ModbusUART_CY_SCBIP_V0 || ModbusUART_CY_SCBIP_V1) */
...
#if(ModbusUART_SCB_IRQ_INTERNAL)
    #define ModbusUART_ISR_NUMBER     ((uint8) ModbusUART_SCB_IRQ__INTC_NUMBER)
    #define ModbusUART_ISR_PRIORITY   ((uint8) ModbusUART_SCB_IRQ__INTC_PRIOR_NUM)
#endif /* (ModbusUART_SCB_IRQ_INTERNAL) */

#if(ModbusUART_UART_RX_WAKEUP_IRQ)
    #define ModbusUART_RX_WAKE_ISR_NUMBER     ((uint8) ModbusUART_RX_WAKEUP_IRQ__INTC_NUMBER)
    #define ModbusUART_RX_WAKE_ISR_PRIORITY   ((uint8) ModbusUART_RX_WAKEUP_IRQ__INTC_PRIOR_NUM)
#endif /* (ModbusUART_UART_RX_WAKEUP_IRQ) */
...
#if !(ModbusUART_CY_SCBIP_V0 || ModbusUART_CY_SCBIP_V1)
    #define ModbusUART_CTRL_BYTE_MODE_POS (11u) /* [11]    Determines the number of bits per FIFO data element */
#endif /* !(ModbusUART_CY_SCBIP_V0 || ModbusUART_CY_SCBIP_V1) */
#define ModbusUART_CTRL_ADDR_ACCEPT_POS   (16u) /* [16]    Put matched address in RX FIFO       */
#define ModbusUART_CTRL_BLOCK_POS         (17u) /* [17]    Ext and Int logic to resolve collide */
...
#define ModbusUART_CTRL_EC_AM_MODE        ((uint32) 0x01u << ModbusUART_CTRL_EC_AM_MODE_POS)
#define ModbusUART_CTRL_EC_OP_MODE        ((uint32) 0x01u << ModbusUART_CTRL_EC_OP_MODE_POS)
#define ModbusUART_CTRL_EZBUF_MODE        ((uint32) 0x01u << ModbusUART_CTRL_EZBUF_MODE_POS)
#if !(ModbusUART_CY_SCBIP_V0 || ModbusUART_CY_SCBIP_V1)
    #define ModbusUART_CTRL_BYTE_MODE ((uint32) 0x01u << ModbusUART_CTRL_BYTE_MODE_POS)
#endif /* !(ModbusUART_CY_SCBIP_V0 || ModbusUART_CY_SCBIP_V1) */
#define ModbusUART_CTRL_ADDR_ACCEPT       ((uint32) 0x01u << ModbusUART_CTRL_ADDR_ACCEPT_POS)
#define ModbusUART_CTRL_BLOCK             ((uint32) 0x01u << ModbusUART_CTRL_BLOCK_POS)
#define ModbusUART_CTRL_MODE_MASK         ((uint32) 0x03u << ModbusUART_CTRL_MODE_POS)
#define ModbusUART_CTRL_MODE_I2C          ((uint32) 0x00u)
#define ModbusUART_CTRL_MODE_SPI          ((uint32) 0x01u << ModbusUART_CTRL_MODE_POS)
#define ModbusUART_CTRL_MODE_UART         ((uint32) 0x02u << ModbusUART_CTRL_MODE_POS)
#define ModbusUART_CTRL_ENABLED           ((uint32) 0x01u << ModbusUART_CTRL_ENABLED_POS)

/* ModbusUART_STATUS_REG */
#define ModbusUART_STATUS_EC_BUSY_POS     (0u)  /* [0] Bus busy. Externally clocked logic access to EZ memory */
...
#if !(ModbusUART_CY_SCBIP_V0 || ModbusUART_CY_SCBIP_V1)
    #define ModbusUART_SPI_CTRL_SCLK_CONTINUOUS_POS   (5u)  /* [5]     Enable continuous SCLK generation */
    #define ModbusUART_SPI_CTRL_SSEL0_POLARITY_POS    (8u)  /* [8]     SS0 polarity                      */
    #define ModbusUART_SPI_CTRL_SSEL1_POLARITY_POS    (9u)  /* [9]     SS1 polarity                      */
    #define ModbusUART_SPI_CTRL_SSEL2_POLARITY_POS    (10u) /* [10]    SS2 polarity                      */
    #define ModbusUART_SPI_CTRL_SSEL3_POLARITY_POS    (11u) /* [11]    SS3 polarity                      */
#endif /* !(ModbusUART_CY_SCBIP_V0 || ModbusUART_CY_SCBIP_V1) */
#define ModbusUART_SPI_CTRL_LOOPBACK_POS          (16u) /* [16]    Local loop-back control enabled            */
...
#define ModbusUART_SPI_CTRL_SELECT_PRECEDE        ((uint32) 0x01u << ModbusUART_SPI_CTRL_SELECT_PRECEDE_POS)
#define ModbusUART_SPI_CTRL_SCLK_MODE_MASK        ((uint32) 0x03u << ModbusUART_SPI_CTRL_CPHA_POS)
#define ModbusUART_SPI_CTRL_CPHA                  ((uint32) 0x01u << ModbusUART_SPI_CTRL_CPHA_POS)
#define ModbusUART_SPI_CTRL_CPOL                  ((uint32) 0x01u << ModbusUART_SPI_CTRL_CPOL_POS)
#define ModbusUART_SPI_CTRL_LATE_MISO_SAMPLE      ((uint32) 0x01u << \
                                                                    ModbusUART_SPI_CTRL_LATE_MISO_SAMPLE_POS)
#if !(ModbusUART_CY_SCBIP_V0 || ModbusUART_CY_SCBIP_V1)
    #define ModbusUART_SPI_CTRL_SCLK_CONTINUOUS  ((uint32) 0x01u << ModbusUART_SPI_CTRL_SCLK_CONTINUOUS_POS)
    #define ModbusUART_SPI_CTRL_SSEL0_POLARITY   ((uint32) 0x01u << ModbusUART_SPI_CTRL_SSEL_POLARITY0_POS)
    #define ModbusUART_SPI_CTRL_SSEL1_POLARITY   ((uint32) 0x01u << ModbusUART_SPI_CTRL_SSEL_POLARITY1_POS)
    #define ModbusUART_SPI_CTRL_SSEL2_POLARITY   ((uint32) 0x01u << ModbusUART_SPI_CTRL_SSEL_POLARITY2_POS)
    #define ModbusUART_SPI_CTRL_SSEL3_POLARITY   ((uint32) 0x01u << ModbusUART_SPI_CTRL_SSEL_POLARITY3_POS)
    #define ModbusUART_SPI_CTRL_SSEL_POLARITY_MASK ((uint32)0x0Fu << ModbusUART_SPI_CTRL_SSEL0_POLARITY_POS)
#endif /* !(ModbusUART_CY_SCBIP_V0 || ModbusUART_CY_SCBIP_V1) */

#define ModbusUART_SPI_CTRL_LOOPBACK              ((uint32) 0x01u << ModbusUART_SPI_CTRL_LOOPBACK_POS)
#define ModbusUART_SPI_CTRL_MODE_MASK             ((uint32) 0x03u << ModbusUART_SPI_CTRL_MODE_POS)
#define ModbusUART_SPI_CTRL_MODE_MOTOROLA         ((uint32) 0x00u)
#define ModbusUART_SPI_CTRL_MODE_TI               ((uint32) 0x01u << ModbusUART_CTRL_MODE_POS)
#define ModbusUART_SPI_CTRL_MODE_NS               ((uint32) 0x02u << ModbusUART_CTRL_MODE_POS)
#define ModbusUART_SPI_CTRL_SLAVE_SELECT_MASK     ((uint32) 0x03u << ModbusUART_SPI_CTRL_SLAVE_SELECT_POS)
#define ModbusUART_SPI_CTRL_SLAVE_SELECT0         ((uint32) 0x00u)
#define ModbusUART_SPI_CTRL_SLAVE_SELECT1         ((uint32) 0x01u << ModbusUART_SPI_CTRL_SLAVE_SELECT_POS)
#define ModbusUART_SPI_CTRL_SLAVE_SELECT2         ((uint32) 0x02u << ModbusUART_SPI_CTRL_SLAVE_SELECT_POS)
#define ModbusUART_SPI_CTRL_SLAVE_SELECT3         ((uint32) 0x03u << ModbusUART_SPI_CTRL_SLAVE_SELECT_POS)
#define ModbusUART_SPI_CTRL_MASTER                ((uint32) 0x01u << ModbusUART_SPI_CTRL_MASTER_MODE_POS)
...
#define ModbusUART_SPI_STATUS_EZBUF_ADDR_MASK ((uint32) 0xFFu << ModbusUART_I2C_STATUS_EZBUF_ADDR_POS)

/* ModbusUART_UART_CTRL */
#define ModbusUART_UART_CTRL_LOOPBACK_POS         (16u) /* [16] Loop-back    */
#define ModbusUART_UART_CTRL_MODE_POS             (24u) /* [24] UART subMode */
#define ModbusUART_UART_CTRL_LOOPBACK             ((uint32) 0x01u << ModbusUART_UART_CTRL_LOOPBACK_POS)
#define ModbusUART_UART_CTRL_MODE_UART_STD        ((uint32) 0x00u)
#define ModbusUART_UART_CTRL_MODE_UART_SMARTCARD  ((uint32) 0x01u << ModbusUART_UART_CTRL_MODE_POS)
#define ModbusUART_UART_CTRL_MODE_UART_IRDA       ((uint32) 0x02u << ModbusUART_UART_CTRL_MODE_POS)
#define ModbusUART_UART_CTRL_MODE_MASK            ((uint32) 0x03u << ModbusUART_UART_CTRL_MODE_POS)
...
#define ModbusUART_UART_TX_CTRL_PARITY                ((uint32) 0x01u << \
                                                                    ModbusUART_UART_TX_CTRL_PARITY_POS)
#define ModbusUART_UART_TX_CTRL_PARITY_ENABLED        ((uint32) 0x01u << \
                                                                    ModbusUART_UART_TX_CTRL_PARITY_ENABLED_POS)
#define ModbusUART_UART_TX_CTRL_RETRY_ON_NACK         ((uint32) 0x01u << \
                                                                    ModbusUART_UART_TX_CTRL_RETRY_ON_NACK_POS)

/* ModbusUART_UART_RX_CTRL */
#define ModbusUART_UART_RX_CTRL_STOP_BITS_POS             (0u)  /* [2:0] Stop bits: (Stop bits + 1) * 0.5 period*/
...
#define ModbusUART_UART_RX_CTRL_LIN_MODE_POS              (12u) /* [12]  Lin mode: applicable for UART Standard */
#define ModbusUART_UART_RX_CTRL_SKIP_START_POS            (13u) /* [13]  Skip start not: only for UART Standard */
...
#define ModbusUART_UART_RX_CTRL_PARITY                    ((uint32) 0x01u << \
                                                                    ModbusUART_UART_RX_CTRL_PARITY_POS)
#define ModbusUART_UART_RX_CTRL_PARITY_ENABLED            ((uint32) 0x01u << \
                                                                    ModbusUART_UART_RX_CTRL_PARITY_ENABLED_POS)
#define ModbusUART_UART_RX_CTRL_POLARITY                  ((uint32) 0x01u << \
                                                                    ModbusUART_UART_RX_CTRL_POLARITY_POS)
#define ModbusUART_UART_RX_CTRL_DROP_ON_PARITY_ERR        ((uint32) 0x01u << \
                                                                   ModbusUART_UART_RX_CTRL_DROP_ON_PARITY_ERR_POS)
#define ModbusUART_UART_RX_CTRL_DROP_ON_FRAME_ERR         ((uint32) 0x01u << \
                                                                    ModbusUART_UART_RX_CTRL_DROP_ON_FRAME_ERR_POS)
#define ModbusUART_UART_RX_CTRL_MP_MODE                   ((uint32) 0x01u << \
                                                                    ModbusUART_UART_RX_CTRL_MP_MODE_POS)
#define ModbusUART_UART_RX_CTRL_LIN_MODE                  ((uint32) 0x01u << \
                                                                    ModbusUART_UART_RX_CTRL_LIN_MODE_POS)
#define ModbusUART_UART_RX_CTRL_SKIP_START                ((uint32) 0x01u << \
                                                                    ModbusUART_UART_RX_CTRL_SKIP_START_POS)
#define ModbusUART_UART_RX_CTRL_BREAK_WIDTH_MASK          ((uint32) 0x0Fu << \
                                                                    ModbusUART_UART_RX_CTRL_BREAK_WIDTH_POS)
/* ModbusUART_UART_RX_STATUS_REG */
#define ModbusUART_UART_RX_STATUS_BR_COUNTER_POS     (0u)  /* [11:0] Baud Rate counter */
#define ModbusUART_UART_RX_STATUS_BR_COUNTER_MASK    ((uint32) 0xFFFu)

#if !(ModbusUART_CY_SCBIP_V0 || ModbusUART_CY_SCBIP_V1)
    /* ModbusUART_UART_FLOW_CTRL_REG */
    #define ModbusUART_UART_FLOW_CTRL_TRIGGER_LEVEL_POS    (0u)  /* [7:0] RTS RX FIFO trigger level         */
    #define ModbusUART_UART_FLOW_CTRL_RTS_POLARITY_POS     (16u) /* [16]  Polarity of the RTS output signal */
    #define ModbusUART_UART_FLOW_CTRL_CTS_POLARITY_POS     (24u) /* [24]  Polarity of the CTS input signal  */
    #define ModbusUART_UART_FLOW_CTRL_CTS_ENABLED_POS      (25u) /* [25]  Enable CTS signal                 */
    #define ModbusUART_UART_FLOW_CTRL_TRIGGER_LEVEL_MASK   ((uint32) ModbusUART_FF_DATA_NR_LOG2_MASK)
    #define ModbusUART_UART_FLOW_CTRL_RTS_POLARITY         ((uint32) 0x01u << \
                                                                       ModbusUART_UART_FLOW_CTRL_RTS_POLARITY_POS)
    #define ModbusUART_UART_FLOW_CTRL_CTS_POLARITY         ((uint32) 0x01u << \
                                                                       ModbusUART_UART_FLOW_CTRL_CTS_POLARITY_POS)
    #define ModbusUART_UART_FLOW_CTRL_CTS_ENABLE           ((uint32) 0x01u << \
                                                                       ModbusUART_UART_FLOW_CTRL_CTS_ENABLED_POS)
#endif /* !(ModbusUART_CY_SCBIP_V0 || ModbusUART_CY_SCBIP_V1) */

/* ModbusUART_I2C_CTRL */
#define ModbusUART_I2C_CTRL_HIGH_PHASE_OVS_POS           (0u)   /* [3:0] Oversampling factor high: master only */
#define ModbusUART_I2C_CTRL_LOW_PHASE_OVS_POS            (4u)   /* [7:4] Oversampling factor low:  master only */
#define ModbusUART_I2C_CTRL_M_READY_DATA_ACK_POS         (8u)   /* [8]   Master ACKs data while RX FIFO != FULL*/
...
#define ModbusUART_I2C_CTRL_LOOPBACK_POS                 (16u)  /* [16]  Loop-back                             */
...
#define ModbusUART_I2C_CTRL_LOW_PHASE_OVS_MASK   ((uint32) 0x0Fu << \
                                                                ModbusUART_I2C_CTRL_LOW_PHASE_OVS_POS)
#define ModbusUART_I2C_CTRL_M_READY_DATA_ACK      ((uint32) 0x01u << \
                                                                ModbusUART_I2C_CTRL_M_READY_DATA_ACK_POS)
#define ModbusUART_I2C_CTRL_M_NOT_READY_DATA_NACK ((uint32) 0x01u << \
                                                                ModbusUART_I2C_CTRL_M_NOT_READY_DATA_NACK_POS)
#define ModbusUART_I2C_CTRL_S_GENERAL_IGNORE      ((uint32) 0x01u << \
                                                                ModbusUART_I2C_CTRL_S_GENERAL_IGNORE_POS)
#define ModbusUART_I2C_CTRL_S_READY_ADDR_ACK      ((uint32) 0x01u << \
                                                                ModbusUART_I2C_CTRL_S_READY_ADDR_ACK_POS)
#define ModbusUART_I2C_CTRL_S_READY_DATA_ACK      ((uint32) 0x01u << \
                                                                ModbusUART_I2C_CTRL_S_READY_DATA_ACK_POS)
#define ModbusUART_I2C_CTRL_S_NOT_READY_ADDR_NACK ((uint32) 0x01u << \
                                                                ModbusUART_I2C_CTRL_S_NOT_READY_ADDR_NACK_POS)
#define ModbusUART_I2C_CTRL_S_NOT_READY_DATA_NACK ((uint32) 0x01u << \
                                                                ModbusUART_I2C_CTRL_S_NOT_READY_DATA_NACK_POS)
#define ModbusUART_I2C_CTRL_LOOPBACK              ((uint32) 0x01u << \
                                                                ModbusUART_I2C_CTRL_LOOPBACK_POS)
#define ModbusUART_I2C_CTRL_SLAVE_MODE            ((uint32) 0x01u << \
                                                                ModbusUART_I2C_CTRL_SLAVE_MODE_POS)
#define ModbusUART_I2C_CTRL_MASTER_MODE           ((uint32) 0x01u << \
                                                                ModbusUART_I2C_CTRL_MASTER_MODE_POS)
#define ModbusUART_I2C_CTRL_SLAVE_MASTER_MODE_MASK    ((uint32) 0x03u << \
                                                                ModbusUART_I2C_CTRL_SLAVE_MODE_POS)
...
#define ModbusUART_I2C_STATUS_S_READ          ((uint32) 0x01u << ModbusUART_I2C_STATUS_S_READ_POS)
#define ModbusUART_I2C_STATUS_M_READ          ((uint32) 0x01u << ModbusUART_I2C_STATUS_M_READ_POS)
#define ModbusUART_I2C_STATUS_EZBUF_ADDR_MASK ((uint32) 0xFFu << ModbusUART_I2C_STATUS_EZBUF_ADDR_POS)
...
#define ModbusUART_I2C_MASTER_CMD_M_START_ON_IDLE ((uint32) 0x01u << \
                                                                   ModbusUART_I2C_MASTER_CMD_M_START_ON_IDLE_POS)
#define ModbusUART_I2C_MASTER_CMD_M_ACK           ((uint32) 0x01u << \
                                                                   ModbusUART_I2C_MASTER_CMD_M_ACK_POS)
#define ModbusUART_I2C_MASTER_CMD_M_NACK          ((uint32) 0x01u << \
                                                                    ModbusUART_I2C_MASTER_CMD_M_NACK_POS)
#define ModbusUART_I2C_MASTER_CMD_M_STOP          ((uint32) 0x01u << \
...
#define ModbusUART_I2C_SLAVE_CMD_S_NACK       ((uint32) 0x01u << ModbusUART_I2C_SLAVE_CMD_S_NACK_POS)
...
#define ModbusUART_I2C_CFG_SDA_FILT_OUT_HS_POS        (26u) /* [26]    '0': 50 ns filter, '1': 10 ns filter     */
#define ModbusUART_I2C_CFG_SDA_FILT_OUT_ENABLED_POS   (27u) /* [27]    I2C SDA output delay filter enabled      */
#define ModbusUART_I2C_CFG_SDA_FILT_HYS_MASK          ((uint32) 0x03u)
#define ModbusUART_I2C_CFG_SDA_FILT_TRIM_MASK         ((uint32) 0x03u << \
                                                                ModbusUART_I2C_CFG_SDA_FILT_TRIM_POS)
#define ModbusUART_I2C_CFG_SCL_FILT_HYS_MASK          ((uint32) 0x03u << \
                                                                ModbusUART_I2C_CFG_SCL_FILT_HYS_POS)
#define ModbusUART_I2C_CFG_SCL_FILT_TRIM_MASK         ((uint32) 0x03u << \
                                                                ModbusUART_I2C_CFG_SCL_FILT_TRIM_POS)
#define ModbusUART_I2C_CFG_SDA_FILT_OUT_HYS_MASK      ((uint32) 0x03u << \
                                                                ModbusUART_I2C_CFG_SDA_FILT_OUT_HYS_POS)
#define ModbusUART_I2C_CFG_SDA_FILT_OUT_TRIM_MASK     ((uint32) 0x03u << \
                                                                ModbusUART_I2C_CFG_SDA_FILT_OUT_TRIM_POS)
#define ModbusUART_I2C_CFG_SDA_FILT_HS                ((uint32) 0x01u << \
                                                                ModbusUART_I2C_CFG_SDA_FILT_HS_POS)
#define ModbusUART_I2C_CFG_SDA_FILT_ENABLED           ((uint32) 0x01u << \
                                                                ModbusUART_I2C_CFG_SDA_FILT_ENABLED_POS)
#define ModbusUART_I2C_CFG_SCL_FILT_HS                ((uint32) 0x01u << \
                                                                ModbusUART_I2C_CFG_SCL_FILT_HS_POS)
#define ModbusUART_I2C_CFG_SCL_FILT_ENABLED           ((uint32) 0x01u << \
                                                                ModbusUART_I2C_CFG_SCL_FILT_ENABLED_POS)
#define ModbusUART_I2C_CFG_SDA_FILT_OUT_HS            ((uint32) 0x01u << \
                                                                ModbusUART_I2C_CFG_SDA_FILT_OUT_HS_POS)
#define ModbusUART_I2C_CFG_SDA_FILT_OUT_ENABLED       ((uint32) 0x01u << \
                                                                ModbusUART_I2C_CFG_SDA_FILT_OUT_ENABLED_POS)
#else
#define ModbusUART_I2C_CFG_SDA_IN_FILT_TRIM_POS   (0u)  /* [1:0] Trim bits for "i2c_sda_in" 50 ns filter */
#define ModbusUART_I2C_CFG_SDA_IN_FILT_SEL_POS    (4u)  /* [4]   "i2c_sda_in" filter delay: 0 ns and 50 ns */
#define ModbusUART_I2C_CFG_SCL_IN_FILT_TRIM_POS   (8u)  /* [9:8] Trim bits for "i2c_scl_in" 50 ns filter */
#define ModbusUART_I2C_CFG_SCL_IN_FILT_SEL_POS    (12u) /* [12]  "i2c_scl_in" filter delay: 0 ns and 50 ns */
#define ModbusUART_I2C_CFG_SDA_OUT_FILT0_TRIM_POS (16u) /* [17:16] Trim bits for "i2c_sda_out" 50 ns filter 0 */
#define ModbusUART_I2C_CFG_SDA_OUT_FILT1_TRIM_POS (18u) /* [19:18] Trim bits for "i2c_sda_out" 50 ns filter 1 */
#define ModbusUART_I2C_CFG_SDA_OUT_FILT2_TRIM_POS (20u) /* [21:20] Trim bits for "i2c_sda_out" 50 ns filter 2 */
#define ModbusUART_I2C_CFG_SDA_OUT_FILT_SEL_POS   (28u) /* [29:28] Cumulative "i2c_sda_out" filter delay: */

#define ModbusUART_I2C_CFG_SDA_IN_FILT_TRIM_MASK  ((uint32) 0x03u)
#define ModbusUART_I2C_CFG_SDA_IN_FILT_SEL        ((uint32) 0x01u << ModbusUART_I2C_CFG_SDA_IN_FILT_SEL_POS)
#define ModbusUART_I2C_CFG_SCL_IN_FILT_TRIM_MASK  ((uint32) 0x03u << \
                                                            ModbusUART_I2C_CFG_SCL_IN_FILT_TRIM_POS)
#define ModbusUART_I2C_CFG_SCL_IN_FILT_SEL        ((uint32) 0x01u << ModbusUART_I2C_CFG_SCL_IN_FILT_SEL_POS)
#define ModbusUART_I2C_CFG_SDA_OUT_FILT0_TRIM_MASK ((uint32) 0x03u << \
                                                            ModbusUART_I2C_CFG_SDA_OUT_FILT0_TRIM_POS)
#define ModbusUART_I2C_CFG_SDA_OUT_FILT1_TRIM_MASK ((uint32) 0x03u << \
                                                            ModbusUART_I2C_CFG_SDA_OUT_FILT1_TRIM_POS)
#define ModbusUART_I2C_CFG_SDA_OUT_FILT2_TRIM_MASK ((uint32) 0x03u << \
                                                            ModbusUART_I2C_CFG_SDA_OUT_FILT2_TRIM_POS)
#define ModbusUART_I2C_CFG_SDA_OUT_FILT_SEL_MASK   ((uint32) 0x03u << \
                                                            ModbusUART_I2C_CFG_SDA_OUT_FILT_SEL_POS)
#endif /* (ModbusUART_CY_SCBIP_V0) */


/* ModbusUART_TX_CTRL_REG */
#define ModbusUART_TX_CTRL_DATA_WIDTH_POS     (0u)  /* [3:0] Data frame width: (Data width - 1) */
...
#define ModbusUART_TX_CTRL_MSB_FIRST          ((uint32) 0x01u << ModbusUART_TX_CTRL_MSB_FIRST_POS)
#define ModbusUART_TX_CTRL_LSB_FIRST          ((uint32) 0x00u)
#define ModbusUART_TX_CTRL_ENABLED            ((uint32) 0x01u << ModbusUART_TX_CTRL_ENABLED_POS)

/* ModbusUART_TX_CTRL_FIFO_REG */
#define ModbusUART_TX_FIFO_CTRL_TRIGGER_LEVEL_POS     (0u)  /* [2:0] Trigger level                              */
#define ModbusUART_TX_FIFO_CTRL_CLEAR_POS             (16u) /* [16]  Clear TX FIFO: cleared after set           */
#define ModbusUART_TX_FIFO_CTRL_FREEZE_POS            (17u) /* [17]  Freeze TX FIFO: HW do not inc read pointer */
#define ModbusUART_TX_FIFO_CTRL_TRIGGER_LEVEL_MASK    ((uint32) ModbusUART_FF_DATA_NR_LOG2_MASK)
#define ModbusUART_TX_FIFO_CTRL_CLEAR                 ((uint32) 0x01u << ModbusUART_TX_FIFO_CTRL_CLEAR_POS)
#define ModbusUART_TX_FIFO_CTRL_FREEZE                ((uint32) 0x01u << ModbusUART_TX_FIFO_CTRL_FREEZE_POS)
...
#define ModbusUART_TX_FIFO_STATUS_USED_MASK   ((uint32) ModbusUART_FF_DATA_NR_LOG2_PLUS1_MASK)
#define ModbusUART_TX_FIFO_SR_VALID           ((uint32) 0x01u << ModbusUART_TX_FIFO_SR_VALID_POS)
#define ModbusUART_TX_FIFO_STATUS_RD_PTR_MASK ((uint32) ModbusUART_FF_DATA_NR_LOG2_MASK << \
                                                                    ModbusUART_TX_FIFO_STATUS_RD_PTR_POS)
#define ModbusUART_TX_FIFO_STATUS_WR_PTR_MASK ((uint32) ModbusUART_FF_DATA_NR_LOG2_MASK << \
...
#define ModbusUART_RX_CTRL_DATA_WIDTH_POS     (0u)  /* [3:0] Data frame width: (Data width - 1) */
...
#define ModbusUART_RX_CTRL_MSB_FIRST          ((uint32) 0x01u << ModbusUART_RX_CTRL_MSB_FIRST_POS)
#define ModbusUART_RX_CTRL_LSB_FIRST          ((uint32) 0x00u)
#define ModbusUART_RX_CTRL_MEDIAN             ((uint32) 0x01u << ModbusUART_RX_CTRL_MEDIAN_POS)
#define ModbusUART_RX_CTRL_ENABLED            ((uint32) 0x01u << ModbusUART_RX_CTRL_ENABLED_POS)


/* ModbusUART_RX_FIFO_CTRL_REG */
#define ModbusUART_RX_FIFO_CTRL_TRIGGER_LEVEL_POS     (0u)   /* [2:0] Trigger level                            */
#define ModbusUART_RX_FIFO_CTRL_CLEAR_POS             (16u)  /* [16]  Clear RX FIFO: clear after set           */
#define ModbusUART_RX_FIFO_CTRL_FREEZE_POS            (17u)  /* [17]  Freeze RX FIFO: HW writes has not effect */
#define ModbusUART_RX_FIFO_CTRL_TRIGGER_LEVEL_MASK    ((uint32) ModbusUART_FF_DATA_NR_LOG2_MASK)
#define ModbusUART_RX_FIFO_CTRL_CLEAR                 ((uint32) 0x01u << ModbusUART_RX_FIFO_CTRL_CLEAR_POS)
#define ModbusUART_RX_FIFO_CTRL_FREEZE                ((uint32) 0x01u << ModbusUART_RX_FIFO_CTRL_FREEZE_POS)
...
#define ModbusUART_RX_FIFO_STATUS_USED_MASK   ((uint32) ModbusUART_FF_DATA_NR_LOG2_PLUS1_MASK)
#define ModbusUART_RX_FIFO_SR_VALID           ((uint32) 0x01u << ModbusUART_RX_FIFO_SR_VALID_POS)
#define ModbusUART_RX_FIFO_STATUS_RD_PTR_MASK ((uint32) ModbusUART_FF_DATA_NR_LOG2_MASK << \
                                                                    ModbusUART_RX_FIFO_STATUS_RD_PTR_POS)
#define ModbusUART_RX_FIFO_STATUS_WR_PTR_MASK ((uint32) ModbusUART_FF_DATA_NR_LOG2_MASK << \
...
#define ModbusUART_RX_MATCH_MASK_MASK    ((uint32) 0xFFu << ModbusUART_RX_MATCH_MASK_POS)
...
#define ModbusUART_INTR_CAUSE_SLAVE       ((uint32) 0x01u << ModbusUART_INTR_CAUSE_SLAVE_POS)
#define ModbusUART_INTR_CAUSE_TX          ((uint32) 0x01u << ModbusUART_INTR_CAUSE_TX_POS)
#define ModbusUART_INTR_CAUSE_RX          ((uint32) 0x01u << ModbusUART_INTR_CAUSE_RX_POS)
#define ModbusUART_INTR_CAUSE_I2C_EC      ((uint32) 0x01u << ModbusUART_INTR_CAUSE_I2C_EC_POS)
#define ModbusUART_INTR_CAUSE_SPI_EC      ((uint32) 0x01u << ModbusUART_INTR_CAUSE_SPI_EC_POS)
...
#define ModbusUART_INTR_SPI_EC_EZBUF_STOP           ((uint32) 0x01u << \
                                                                    ModbusUART_INTR_SPI_EC_EZBUF_STOP_POS)
#define ModbusUART_INTR_SPI_EC_EZBUF_WRITE_STOP     ((uint32) 0x01u << \
...
#define ModbusUART_INTR_I2C_EC_EZBUF_STOP           ((uint32) 0x01u << \
                                                                    ModbusUART_INTR_I2C_EC_EZBUF_STOP_POS)
#define ModbusUART_INTR_I2C_EC_EZBUF_WRITE_STOP     ((uint32) 0x01u << \
...
#define ModbusUART_INTR_MASTER_SPI_DONE_POS       (9u)  /* [9] Master complete transfer: Only for SPI           */
#define ModbusUART_INTR_MASTER_I2C_ARB_LOST       ((uint32) 0x01u)
#define ModbusUART_INTR_MASTER_I2C_NACK           ((uint32) 0x01u << ModbusUART_INTR_MASTER_I2C_NACK_POS)
#define ModbusUART_INTR_MASTER_I2C_ACK            ((uint32) 0x01u << ModbusUART_INTR_MASTER_I2C_ACK_POS)
#define ModbusUART_INTR_MASTER_I2C_STOP           ((uint32) 0x01u << ModbusUART_INTR_MASTER_I2C_STOP_POS)
#define ModbusUART_INTR_MASTER_I2C_BUS_ERROR      ((uint32) 0x01u << \
                                                                    ModbusUART_INTR_MASTER_I2C_BUS_ERROR_POS)
#define ModbusUART_INTR_MASTER_SPI_DONE           ((uint32) 0x01u << ModbusUART_INTR_MASTER_SPI_DONE_POS)
...
#define ModbusUART_INTR_SLAVE_I2C_STOP_POS             (4u)  /* [4]  Slave detects end of transaction intended */
...
#define ModbusUART_INTR_SLAVE_SPI_EZBUF_STOP_POS       (10u) /* [10] Slave end of transaction: Only for SPI   */
...
#define ModbusUART_INTR_SLAVE_I2C_NACK                 ((uint32) 0x01u << \
                                                                    ModbusUART_INTR_SLAVE_I2C_NACK_POS)
#define ModbusUART_INTR_SLAVE_I2C_ACK                  ((uint32) 0x01u << \
                                                                    ModbusUART_INTR_SLAVE_I2C_ACK_POS)
#define ModbusUART_INTR_SLAVE_I2C_WRITE_STOP           ((uint32) 0x01u << \
                                                                    ModbusUART_INTR_SLAVE_I2C_WRITE_STOP_POS)
#define ModbusUART_INTR_SLAVE_I2C_STOP                 ((uint32) 0x01u << \
                                                                    ModbusUART_INTR_SLAVE_I2C_STOP_POS)
#define ModbusUART_INTR_SLAVE_I2C_START                ((uint32) 0x01u << \
                                                                    ModbusUART_INTR_SLAVE_I2C_START_POS)
#define ModbusUART_INTR_SLAVE_I2C_ADDR_MATCH           ((uint32) 0x01u << \
                                                                    ModbusUART_INTR_SLAVE_I2C_ADDR_MATCH_POS)
#define ModbusUART_INTR_SLAVE_I2C_GENERAL              ((uint32) 0x01u << \
                                                                    ModbusUART_INTR_SLAVE_I2C_GENERAL_POS)
#define ModbusUART_INTR_SLAVE_I2C_BUS_ERROR            ((uint32) 0x01u << \
                                                                    ModbusUART_INTR_SLAVE_I2C_BUS_ERROR_POS)
#define ModbusUART_INTR_SLAVE_SPI_EZBUF_WRITE_STOP     ((uint32) 0x01u << \
                                                                   ModbusUART_INTR_SLAVE_SPI_EZBUF_WRITE_STOP_POS)
#define ModbusUART_INTR_SLAVE_SPI_EZBUF_STOP           ((uint32) 0x01u << \
                                                                    ModbusUART_INTR_SLAVE_SPI_EZBUF_STOP_POS)
#define ModbusUART_INTR_SLAVE_SPI_BUS_ERROR           ((uint32) 0x01u << \
...
#define ModbusUART_INTR_TX_FIFO_LEVEL         (ModbusUART_INTR_TX_TRIGGER)
#define ModbusUART_INTR_TX_NOT_FULL           ((uint32) 0x01u << ModbusUART_INTR_TX_NOT_FULL_POS)
#define ModbusUART_INTR_TX_EMPTY              ((uint32) 0x01u << ModbusUART_INTR_TX_EMPTY_POS)
#define ModbusUART_INTR_TX_OVERFLOW           ((uint32) 0x01u << ModbusUART_INTR_TX_OVERFLOW_POS)
#define ModbusUART_INTR_TX_UNDERFLOW          ((uint32) 0x01u << ModbusUART_INTR_TX_UNDERFLOW_POS)
#define ModbusUART_INTR_TX_BLOCKED            ((uint32) 0x01u << ModbusUART_INTR_TX_BLOCKED_POS)
#define ModbusUART_INTR_TX_UART_NACK          ((uint32) 0x01u << ModbusUART_INTR_TX_UART_NACK_POS)
#define ModbusUART_INTR_TX_UART_DONE          ((uint32) 0x01u << ModbusUART_INTR_TX_UART_DONE_POS)
#define ModbusUART_INTR_TX_UART_ARB_LOST      ((uint32) 0x01u << ModbusUART_INTR_TX_UART_ARB_LOST_POS)
...
#define ModbusUART_INTR_RX_BAUD_DETECT_POS    (10u)  /* [10] LIN baud rate detection is completed   */
...
#define ModbusUART_INTR_RX_FIFO_LEVEL         (ModbusUART_INTR_RX_TRIGGER)
#define ModbusUART_INTR_RX_NOT_EMPTY          ((uint32) 0x01u << ModbusUART_INTR_RX_NOT_EMPTY_POS)
#define ModbusUART_INTR_RX_FULL               ((uint32) 0x01u << ModbusUART_INTR_RX_FULL_POS)
#define ModbusUART_INTR_RX_OVERFLOW           ((uint32) 0x01u << ModbusUART_INTR_RX_OVERFLOW_POS)
#define ModbusUART_INTR_RX_UNDERFLOW          ((uint32) 0x01u << ModbusUART_INTR_RX_UNDERFLOW_POS)
#define ModbusUART_INTR_RX_BLOCKED            ((uint32) 0x01u << ModbusUART_INTR_RX_BLOCKED_POS)
#define ModbusUART_INTR_RX_FRAME_ERROR        ((uint32) 0x01u << ModbusUART_INTR_RX_FRAME_ERROR_POS)
#define ModbusUART_INTR_RX_PARITY_ERROR       ((uint32) 0x01u << ModbusUART_INTR_RX_PARITY_ERROR_POS)
#define ModbusUART_INTR_RX_BAUD_DETECT        ((uint32) 0x01u << ModbusUART_INTR_RX_BAUD_DETECT_POS)
#define ModbusUART_INTR_RX_BREAK_DETECT       ((uint32) 0x01u << ModbusUART_INTR_RX_BREAK_DETECT_POS)
...
/* Write interrupt source: set sourceMask bits in ModbusUART_INTR_X_MASK_REG */
...
/* Enable interrupt source: set sourceMask bits in ModbusUART_INTR_X_MASK_REG */
...
/* Disable interrupt source: clear sourceMask bits in ModbusUART_INTR_X_MASK_REG */
...
/* Set interrupt sources: write sourceMask bits in ModbusUART_INTR_X_SET_REG */
...
/* Clear interrupt sources: write sourceMask bits in ModbusUART_INTR_X_REG */
...
#define ModbusUART_CHECK_INTR_I2C_EC(sourceMask)  (0u != (ModbusUART_INTR_I2C_EC_REG & (sourceMask)))
#if (!ModbusUART_CY_SCBIP_V1)
    #define ModbusUART_CHECK_INTR_SPI_EC(sourceMask)  (0u != (ModbusUART_INTR_SPI_EC_REG & (sourceMask)))
#endif /* (!ModbusUART_CY_SCBIP_V1) */
...
/* Return true if sourceMask is set in ModbusUART_CTRL_REG: generally is used to check enable bit */
...
#define ModbusUART_I2C_SLAVE_GENERATE_ACK \
    ...
    #define ModbusUART_I2C_SLAVE_GENERATE_NACK ModbusUART_I2CSlaveNackGeneration()
...
#define ModbusUART_I2C_SLAVE_CLEAR_NACK \
                            do{               \
                                ModbusUART_I2C_SLAVE_CMD_REG = 0u; \
                            }while(0)
...
#define ModbusUART_DIGITAL_FILTER_DISABLE    (0u)
#define ModbusUART_DIGITAL_FILTER_ENABLE     (1u)
#define ModbusUART_I2C_DATA_RATE_FS_MODE_MAX (400u)
#if (ModbusUART_CY_SCBIP_V0)
    /* ModbusUART_I2C_CFG_SDA_FILT_OUT_ENABLED is disabled by default */
    #define ModbusUART_I2C_CFG_FILT_MASK  (ModbusUART_I2C_CFG_SDA_FILT_ENABLED | \
                                                 ModbusUART_I2C_CFG_SCL_FILT_ENABLED)
#else
    /* ModbusUART_I2C_CFG_SDA_OUT_FILT_SEL_MASK is disabled by default */
    #define ModbusUART_I2C_CFG_FILT_MASK  (ModbusUART_I2C_CFG_SDA_IN_FILT_SEL | \
                                                 ModbusUART_I2C_CFG_SCL_IN_FILT_SEL)
#endif /* (ModbusUART_CY_SCBIP_V0) */

#define ModbusUART_I2C_CFG_ANALOG_FITER_DISABLE \
        do{                                           \
            ModbusUART_I2C_CFG_REG &= (uint32) ~ModbusUART_I2C_CFG_FILT_MASK; \
        }while(0)

#define ModbusUART_I2C_CFG_ANALOG_FITER_ENABLE \
        do{                                          \
            ModbusUART_I2C_CFG_REG |= (uint32)  ModbusUART_I2C_CFG_FILT_MASK; \
        }while(0)
...
/* Return true if bit is set in ModbusUART_I2C_STATUS_REG */
#define ModbusUART_CHECK_I2C_STATUS(sourceMask)   (0u != (ModbusUART_I2C_STATUS_REG & (sourceMask)))

/* Return true if bit is set in ModbusUART_SPI_STATUS_REG */
#define ModbusUART_CHECK_SPI_STATUS(sourceMask)   (0u != (ModbusUART_SPI_STATUS_REG & (sourceMask)))

/* Return FIFO size depends on ModbusUART_CTRL_BYTE_MODE bit */
#define ModbusUART_GET_FIFO_SIZE(condition) ((0u != (condition)) ? \
                                                    (2u * ModbusUART_FIFO_SIZE) : (ModbusUART_FIFO_SIZE))
...
#if (ModbusUART_CY_SCBIP_V0 || ModbusUART_CY_SCBIP_V1)
    #define ModbusUART_GET_CTRL_BYTE_MODE(mode)   (0u)
#else
    #define ModbusUART_GET_CTRL_BYTE_MODE(mode)   ((0u != (mode)) ? \
                                                            (ModbusUART_CTRL_BYTE_MODE) : (0u))
#endif /* (ModbusUART_CY_SCBIP_V0 || ModbusUART_CY_SCBIP_V1) */
...
#define ModbusUART_GET_I2C_CTRL_LOW_PHASE_OVS(oversampleLow)  ((((uint32) (oversampleLow) - 1u) << \
                                                                    ModbusUART_I2C_CTRL_LOW_PHASE_OVS_POS) &  \
...
#define ModbusUART_GET_I2C_CTRL_SL_MSTR_MODE(mode)    ((uint32)(mode) << ModbusUART_I2C_CTRL_SLAVE_MODE_POS)
...
#define ModbusUART_GET_SPI_CTRL_SCLK_MODE(mode)       (((uint32) (mode) << \
...
#if (ModbusUART_CY_SCBIP_V0 || ModbusUART_CY_SCBIP_V1)
    #define ModbusUART_GET_SPI_CTRL_SCLK_CONTINUOUS(sclkType) (0u)
    #define ModbusUART_GET_SPI_CTRL_SSEL_POLARITY(polarity)   (0u)
#else
    #define ModbusUART_GET_SPI_CTRL_SCLK_CONTINUOUS(sclkType) ((0u != (sclkType)) ? \
                                                                    (ModbusUART_SPI_CTRL_SCLK_CONTINUOUS) : (0u))

    #define ModbusUART_GET_SPI_CTRL_SSEL_POLARITY(polarity)   (((uint32) (polarity) << \
                                                                     ModbusUART_SPI_CTRL_SSEL0_POLARITY_POS) & \
                                                                     ModbusUART_SPI_CTRL_SSEL_POLARITY_MASK)
#endif /* ((ModbusUART_CY_SCBIP_V0 || ModbusUART_CY_SCBIP_V1) */

#define ModbusUART_GET_SPI_CTRL_SUB_MODE(mode)        (((uint32) (mode) << ModbusUART_SPI_CTRL_MODE_POS) & \
                                                                                 ModbusUART_SPI_CTRL_MODE_MASK)

#define ModbusUART_GET_SPI_CTRL_SLAVE_SELECT(select)  (((uint32) (select) << \
                                                                      ModbusUART_SPI_CTRL_SLAVE_SELECT_POS) & \
                                                                      ModbusUART_SPI_CTRL_SLAVE_SELECT_MASK)
...
/* ModbusUART_UART_CTRL */
#define ModbusUART_GET_UART_CTRL_MODE(mode)           (((uint32) (mode) << \
...
/* ModbusUART_UART_FLOW_CTRL */
#if !(ModbusUART_CY_SCBIP_V0 || ModbusUART_CY_SCBIP_V1)
    #define ModbusUART_GET_UART_FLOW_CTRL_TRIGGER_LEVEL(level)   ( (uint32) (level) & \
                                                                 ModbusUART_UART_FLOW_CTRL_TRIGGER_LEVEL_MASK)

    #define ModbusUART_GET_UART_FLOW_CTRL_RTS_POLARITY(polarity) ((0u != (polarity)) ? \
                                                                (ModbusUART_UART_FLOW_CTRL_RTS_POLARITY) : (0u))

    #define ModbusUART_GET_UART_FLOW_CTRL_CTS_POLARITY(polarity) ((0u != (polarity)) ? \
                                                                (ModbusUART_UART_FLOW_CTRL_CTS_POLARITY) : (0u))

    #define ModbusUART_GET_UART_FLOW_CTRL_CTS_ENABLE(ctsEn)      ((0u != (ctsEn)) ? \
                                                                (ModbusUART_UART_FLOW_CTRL_CTS_ENABLE) : (0u))
#endif /* !(ModbusUART_CY_SCBIP_V0 || ModbusUART_CY_SCBIP_V1) */
...
#define ModbusUART_GET_RX_MATCH_MASK(mask)    (((uint32) (mask) << \
...
#define ModbusUART_CHECK_INTR_EC_I2C(sourceMask)  ModbusUART_CHECK_INTR_I2C_EC(sourceMask)
#if (!ModbusUART_CY_SCBIP_V1)
    #define ModbusUART_CHECK_INTR_EC_SPI(sourceMask)  ModbusUART_CHECK_INTR_SPI_EC(sourceMask)
#endif /* (!ModbusUART_CY_SCBIP_V1) */

#define ModbusUART_CY_SCBIP_V1_I2C_ONLY   (ModbusUART_CY_SCBIP_V1)
