...
#define ModbusUART_MOSI_SCL_RX_PIN_MASK      ((uint32) 0x01u << ModbusUART_MOSI_SCL_RX_PIN_INDEX)
#define ModbusUART_MOSI_SCL_RX_WAKE_PIN_MASK ((uint32) 0x01u << ModbusUART_MOSI_SCL_RX_WAKE_PIN_INDEX)
#define ModbusUART_MISO_SDA_TX_PIN_MASK      ((uint32) 0x01u << ModbusUART_MISO_SDA_TX_PIN_INDEX)
#define ModbusUART_SCLK_PIN_MASK             ((uint32) 0x01u << ModbusUART_SCLK_PIN_INDEX)
#define ModbusUART_SS0_PIN_MASK              ((uint32) 0x01u << ModbusUART_SS0_PIN_INDEX)
...
/* Unconfigured SCB: scl signal */
#elif(ModbusUART_MOSI_SCL_RX_WAKE_PIN)
    ...
    #define ModbusUART_WAIT_SCL_SET_HIGH  (0u == ModbusUART_spi_mosi_i2c_scl_uart_rx_wake_Read())
    ...
    #define ModbusUART_WAIT_SCL_SET_HIGH  (0u == ModbusUART_spi_mosi_i2c_scl_uart_rx_Read())
...
#elif(ModbusUART_MISO_SDA_TX_PIN)
    #define ModbusUART_WAIT_SDA_SET_HIGH  (0u == ModbusUART_spi_miso_i2c_sda_uart_tx_Read())
